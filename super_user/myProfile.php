 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 style="font-size:15px !important">MY PROFILE<small>Control panel</small></h1>
      <ol class="breadcrumb">
      	...
      	<div class="col-sm-4">
			...
			<div class="box box-success">
				<div class="box-header with-border">
					<h3 class="box-title"><?php echo ucfirst($user_data['firstname'])." ".ucfirst($user_data['lastname']);?></h3>
