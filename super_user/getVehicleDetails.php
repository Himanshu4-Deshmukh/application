<?php 
	...
	if($_POST)
    {
    	if(isset($_POST['add']))
		{
		    ...
		    $data['va_customer'] =$_POST['customer'];
		    // --------------------------------------------------------
...
?>
      ...
      <!-- Small boxes (Stat box) -->
        ...
        <div class="box box-success"  id="userForm" style="display:none;">
      	...
      	<div class="box box-success" >
				<div class="box-header with-border">
					<?php $totalVehicle = getVehicleCountByUid($customer); ?>
				...
				<div class="box-body " style="padding:20px;">
                                <form action="" method="post">
                                    <div class="input-group mb-3" style="display: inline;">
                                        <input type="text" class="form-control a1" placeholder="Search" name="search" style="width: 20%">
 ...
 -->
					        ...
					        <?php
									...
									$cur_page = ($page-1)*$rpp;
									$c=($page*10)-9;
									$sql="SELECT * FROM vehicle WHERE customer_id = '$customer' LIMIT " . $cur_page . ',' .  $rpp;
									$result = mysqli_query($conn, $sql);
									while($row=mysqli_fetch_assoc($result))
											{
												$v_data[] = $row;
