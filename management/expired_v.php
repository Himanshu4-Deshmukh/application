            ...
            <div class="col-lg-12 col-md-12">
              <div class="card">
                <div class="card-header card-header-warning">
                  <h4 class="card-title" style="display: inline">Expired Vehicles</h4>
                ...
                <div class="card-body table-responsive">
                 ...
                 <?php
                  ...
                  {
                    $prev="expired_v.php?page=".($page-1);
                  }
                  ...
                  {
                    $nxt="expired_v.php?page=".($page+1);
                  }
                

                      echo '<div id="pagination_div" style="margin: 0px auto; text-align: center;">
                      <a href="expired_v.php?page=1" style="margin-right: 10%"><i class="fa fa-fast-backward" style="color:grey"></i></a>
                  ...
                  <a href="expired_v.php?page='.$num_pages.'" style="margin-left: 10%"><i class="fa fa-fast-forward" style="color:grey"></i></a>
                  </div>';
                      ?>
                </div>
              </div>
