      ...
      <div class="content mt-0 pt-4">
        <div class="container-fluid">
          ...
          // jass new change
            ...
            $count_all_v = mysqli_num_rows($result);
          ?> 
            <div class="col-lg-3 col-md-6 col-sm-6">
              ...
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <h3 class="card-title"><?= $count_all_v; ?></h3>
                </div>
            ...
            <div class="col-lg-12 col-md-12">
              <div class="card">
                <div class="card-header card-header-warning">
                  <h4 class="card-title" style="display: inline">Total Vehicles</h4>
                ...
                <div class="card-body table-responsive">
                  ...
                  while($row=mysqli_fetch_assoc($result))
                      ...
                      else
                      {
                        $rpp=10;
                          ...
                          $sql="SELECT * FROM vehicle WHERE customer_id = '$cust' LIMIT " . $cur_page . ',' .  $rpp;
                          $result=mysqli_query($conn,$sql);
                 ...
                 <?php
                  ...
                  {
                    $nxt="all_v.php?page=".($page+1);
                  }
                

                      echo '<div id="pagination_div" style="margin: 0px auto; text-align: center;">
                      <a href="all_v.php?page=1" style="margin-right: 10%"><i class="fa fa-fast-backward" style="color:grey"></i></a>
                  ...
                  <a href="all_v.php?page='.$num_pages.'" style="margin-left: 10%"><i class="fa fa-fast-forward" style="color:grey"></i></a>
                  </div>';
                      ?>
                </div>
              </div>
