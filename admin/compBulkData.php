						...
						if($file_size < 1024) {
							...
							if($isUploaded) {
								...
								foreach($drawings as $drawing)
								{
									...
									file_put_contents('../uploads/customer_company_logo/'.$image_name[$i-1],$imageContents);
									$i++;
								}
								...
								$query = "insert into `customer` (`id`, `cust_id`, `company_logo`, `company_name`, `company_email`, `company_address`, `owner_name`, `owner_email`, `owner_contact_no`, `contact_p_name`, `cp_contact_no`, `cp_email`, `gstin`, `cin`, `pan_no`, `status`) VALUES ";
