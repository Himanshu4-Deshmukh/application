 ...
 <!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Apply Online Management  |
        <small>Control panel</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Apply Online Management</li>
      </ol>
    </section><br/>
      ...
      <!-- Small boxes (Stat box) -->
      	...
      	<div class="box box-success" >
			<div class="box-header with-border">
				<h3 class="box-title"><b>Apply Online Details</b></h3>
				        		...
				        		if($apply)
				        		{
				        			...
				        			foreach ($apply as $val) 
				        			{
					        			...
					        			<tr>
							                ...
							                <th><a  style="display:inline;" onclick="changeStatus('<?php echo $val['status'] ?>' , '<?php echo $val['id'] ?>' )" id="status" class="<?php if($val['status'] =='1'){echo "btn btn-success"; } else{ echo "btn btn-danger"; }  ?>" ><?php if($val['status'] =='1'){echo "Action Taken"; } else{ echo "Pending"; }  ?></a></th>
