...
<link rel="stylesheet" href="style1.css"></script>
    ...
    //   $id = $_GET["id"];
	  ...
	  //   print_R($activePollution);die();
		...
		?>   
		 <section class="content-header">
		      <ol class="breadcrumb">
        <li><a href="https://vahanfin.com/application/rtt/dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Fleet Dashboard</li>
      </ol>
		 <div class="box-header with-border">
					<?php $totalVehicle = getVehicleCountByUid($id); ?>
					<h3 class="notification_btn">TOTAL VEHICLE  &nbsp; &nbsp;<u style="font-size: 12px;"><?php echo $totalVehicle ?></u></p></h3>
...
<div class="count_content">   <a href="viewActiveSecDetails.php?sec=insurence_expiry_date">
<p>Insurance</p><h3><?php echo $activeInsurence['count']." "; ?></span> </h3><a href="viewExpiredSecDetails.php?sec=insurence_expiry_date" class="notification_btn yellow_btn"><?php echo $expiredInsurence['count'].""; ?>&nbsp;&nbsp;Expired</a>

</div><a href="viewExpSecDetails.php?sec=insurence_expiry_date" class="notification_btn"><?php echo $expInsurence['count']." "; ?>&nbsp;&nbsp; Expiring</a>
...
<p>Pollution</p><h3><?php echo $activePollution['count']." "; ?></span> </h3><a href="#" class="notification_btn yellow_btn"><?php echo $expiredPollution['count']." "; ?>&nbsp;&nbsp;Expired</a>

</div><a href="#" class="notification_btn"><?php echo $expPollution['count']." "; ?>&nbsp;&nbsp; Expiring</a>

<div id="bar2" class="barfiller">
<div class="tipWrap" style="display: inline;">

</div>
<span class="fill" data-percentage="100" style="background: rgb(255, 191, 67); width: 144.3px; transition: width 2.5s ease-in-out 0s;"></span>
</div>
</div><div class="single_quick_activity">
<div class="count_content">   <a href="totalRecDocument.php">
<p>Fitness</p><h3><?php echo $activeFitness['count']." "; ?></span> </h3><a href="#" class="notification_btn yellow_btn"><?php echo $expiredFitness['count'].""; ?>&nbsp;&nbsp;Expired</a>
...
<span class="fill" data-percentage="100" style="background: rgb(75, 230, 157); width: 166.5px; transition: width 3s ease-in-out 0s;"></span>
</div>
</div><div class="single_quick_activity">
<div class="count_content">   <a href="totalRecDocument.php">
<p>Road Tax</p><h3><?php echo $activeTt['count']." "; ?></span> </h3><a href="#" class="notification_btn yellow_btn"><?php echo $expiredTt['count'].""; ?>&nbsp;&nbsp;Expired</a>

</div><a href="#" class="notification_btn"><?php echo $expTt['count']." "; ?>&nbsp;&nbsp; Expiring</a>

<div id="bar2" class="barfiller">
<div class="tipWrap" style="display: inline;">

</div><span class="fill" data-percentage="100" style="background: rgb(146, 103, 255); width: 188.7px; transition: width 3.5s ease-in-out 0s;"></span>
</div>
</div>
</div>
</div>
			...
			<div class="box-body " style="padding:30px;">
				...
				<form  class="form-horizontal" action="#" id="regForm" method="POST" enctype="multipart/form-data"><br/>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <div class="panel panel-default">
							<div class="panel-heading" style="color: #070432; font-size: 16px ">Loan Statement Notice and Invoice</div>
								<div class="panel-body">
									<div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <div class="panel panel-default">
							<div class="panel-heading" style="color: #070432; font-size: 16px ">KYC Registered owner and SFL</div>
								<div class="panel-body">
									<div class="form-group row">
                      ...
                      <div class="form-group row">
                        <div class="col-sm-12">
                            <div class="panel panel-default">
							<div class="panel-heading" style="color: #070432; font-size: 16px ">Form 24,35,36 and Bank NOC</div>
								<div class="panel-body">
									<div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <div class="panel panel-default">
							<div class="panel-heading" style="color: #070432; font-size: 16px ">SFL Authorised Person (Adhaar and Photo)</div>
								<div class="panel-body">
									<div class="form-group row">
					            ...
					            <tr>
					                ...
					                <th style="text-align: center; font-size:12px">Vehicle No</th>
					                       <th style="text-align: center; font-size:12px" class="dm">Insurance</th>
					                       	...
					                       	<th style="text-align: center; font-size:12px" class="dm">Road tax</th>
					                       	
					                <th style="text-align: center; font-size:12px" class="dm">Fitness</th>
					                <th style="text-align: center; font-size:12px" class="dm">Permit</th>
											...
											foreach ($v_data as $val) 
					        			{
											   ...
											   <td style="text-align: center;"><?php echo $val['reg_no'] ?></td>
											   		   <td class="dm" style="text-align: center;"><?php echo date('d-m-Y',strtotime($val['insurence_expiry_date'])); ?></td>
											   		   		   <td class="dm" style="text-align: center;"><?php echo date('d-m-Y',strtotime($val['pollution_expiry_date'])); ?></td>
											   <td class="dm" style="text-align: center;"><?php echo date('d-m-Y',strtotime($val['fitness_expiry_date'])); ?></td>
											   								   <td class="dm" style="text-align: center;"><?php echo date('d-m-Y',strtotime($val['tt_expiry_date'])); ?></td>
											   
											   <td class="dm" style="text-align: center;"><?php echo date('d-m-Y',strtotime($val['permit_expiry_date'])); ?></td>
