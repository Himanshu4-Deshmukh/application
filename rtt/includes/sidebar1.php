...
<aside class="main-sidebar" style="background-color: rgba(14,26,53,1) !important;" >
   ...
   <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                          <li ><a href="https://vahanfin.com/application/frcgetVehicleDetails.php"><i class="fa fa-circle-o"></i> Fresh Registration</a></li>
                 ...
                 <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <li ><a href="1getVehicleDetails.php"><i class="fa fa-circle-o"></i>RTO wise pricing</a></li>
                ...
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <li ><a href="service/dashboard.php"><i class="fa fa-circle-o"></i>View Status</a></li>
