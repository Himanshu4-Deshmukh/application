						...
						<table id="vehicle_tbl" class="table-bordered table-hover table table-striped" style="width:100%">
					        <thead>
					            <tr>
					                ...
					                <th style="text-align: center; font-size:12px" class="dm">Vehicle Model</th>
					        ...
					        <?php
                                ...
                                <td class="dm" style="text-align: center;"><?php echo date('d-m-Y',strtotime($val['reg_date'])); ?></td>
								                ...
								                <td style="text-align: center;">
								                	<a href= "frcgetVehicleDetails.php?id=<?php echo $val['id'] ?>">
								                		<i class="fa fa-eye"></i>
								                	</a>
							                	</td>
                                ...
                                <td class="dm" style="text-align: center;"><?php echo date('d-m-Y',strtotime($val['tt_expiry_date'])); ?></td>
								                <td class="dm" style="text-align: center;"><?php echo date('d-m-Y',strtotime($val['insurence_issue_date'])); ?></td>
								                <td class="dm" style="text-align: center;"><?php echo date('d-m-Y',strtotime($val['reg_date'])); ?></td>
