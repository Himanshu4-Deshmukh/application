 <aside class="main-sidebar" style="background-color: rgba(14,26,53,1) !important;position: fixed;">
...
<br><br>
     ...
     <li class="treeview">
         <a href="#">
           <i class="fa fa-crosshairs"></i> <span>Main Dashboard</span>
           <span class="pull-right-container">
             <i class="fa fa-angle-left pull-right"></i>
           </span>
         </a>
         <ul class="treeview-menu">
           <li><a href="http://localhost:3000/dashboard.php"><i class="fa fa-circle-o"></i> Dashboard</a></li>
       ...
       <li class="treeview">
         <a href="dashboard.php">
           <i class="fa fa-dashboard"></i> <span>Tracking Dashboard</span>
           <span class="pull-right-container">
             <i class="fa fa-angle-left pull-right"></i>
           </span>
         </a>
       ...
       <li class="treeview">
         ...
         <ul class="treeview-menu">
           <li><a href="totalVehicle.php"><i class="fa fa-circle-o"></i>Status</a></li>
