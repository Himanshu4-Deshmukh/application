              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title" style="display: inline !important">
                    <span style="float: left; font-size:15px">PENDING VEHICLES </span><br>
                  ...
                  <div class="table-responsive">
                    <table class="no-margin table-bordered table-hover table table-striped">
                      ...
                      $(document).ready(function(){
                          ...
                          $rpp = 8;
                          $sql = "SELECT * FROM `track` RIGHT JOIN `vehicle` ON track.vehicle_id = vehicle.id   WHERE  track.complete = '0' AND vehicle.user_id = '$id'";
                          $result = mysqli_query($conn, $sql);
                          ...
                          $cur_page = ($page - 1) * $rpp;
                          $c = ($page * 2) - 1;
                          $sql = "SELECT * FROM `track` RIGHT JOIN `vehicle` ON track.vehicle_id = vehicle.id  WHERE  track.complete = '0' AND vehicle.user_id = '$id' LIMIT " . $cur_page . ',' .  $rpp;
                          $result = mysqli_query($conn, $sql);
                          while ($row = mysqli_fetch_assoc($result)) {
                            echo '<tr>
                            <td class="mob" style="text-align: center; ">' . $c . '</td>
