...
<aside class="main-sidebar" style="background-color: rgba(14,26,53,1) !important;" >
   ...
   <li class="treeview">
                  <a href="#">
                    <i class="fa fa-crosshairs"></i> <span>Fresh Registration</span>
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                  <ul class="treeview-menu">
                    <li ><a href="http://localhost/application/application/rtt/dashboardfleet.php"><i class="fa fa-circle-o"></i> Add vehicle</a></li>
               ...
               <li class="treeview">
                  <a href="#">
                    <i class="fa fa-crosshairs"></i> <span>Other Services</span>
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                  <ul class="treeview-menu">
                    <li ><a href="rto/dashboard.php"><i class="fa fa-circle-o"></i>RTO wise pricing</a></li>
