              ...
              if($challan)
              {
                ...
                <li>
                  ...
                  <div class="timeline-item">
                    ...
                    <h3 class="timeline-header"><a href="#">Challan Process</a>.</h3>
              ...
              if($dto_passing)
              {
                ...
                <li>
                  ...
                  <div class="timeline-item">
                    ...
                    <h3 class="timeline-header"><a href="#">DTO Passing</a>.</h3>
              ...
              if($mvi_passing)
              {
                ...
                <li>
                  ...
                  <div class="timeline-item">
                    ...
                    <h3 class="timeline-header"><a href="#">MVI Passing</a>.</h3>
              ...
              if($rc_card)
              {
                ...
                <li>
                  ...
                  <div class="timeline-item">
                    ...
                    <h3 class="timeline-header"><a href="#">RC Card Processing</a>.</h3>
