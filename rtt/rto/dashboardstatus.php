      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-6">
          <div>      
            ...
            <span class="info-box-text" id="demo21"></span>
               <span class="info-box-icon bg-blue"> <img src="https://as1.ftcdn.net/v2/jpg/04/87/13/40/1000_F_487134056_ttJAg56QAcB15RKhdOQUKPXGxwGt5xqB.jpg" width="130" height="30"><?php
              ...
              <br>
            <span class="info-box-text" id="demo11"></span>
            </div>
          </div>
        </div>
        </a>
        ...
        <div class="col-md-3 col-sm-6 col-xs-6">
          <div>      
            <div class="info-box-content">
            <span class="info-box-text" id="demo22"></span>
            <span class="info-box-icon bg-yellow"> <img src="https://as1.ftcdn.net/v2/jpg/04/87/13/40/1000_F_487134056_ttJAg56QAcB15RKhdOQUKPXGxwGt5xqB.jpg" width="130" height="30"><?php
              ...
              <br>
            <span class="info-box-text" id="demo12"></span>
            </div>
          </div>
        </div>
        </a>
        ...
        <div class="col-md-3 col-sm-6 col-xs-6">
          <div>      
            <div class="info-box-content"> 
            <span class="info-box-text" id="demo23"></span>
         <span class="info-box-icon bg-red"> <img src="https://as1.ftcdn.net/v2/jpg/04/87/13/40/1000_F_487134056_ttJAg56QAcB15RKhdOQUKPXGxwGt5xqB.jpg" width="130" height="30"> <?php
              ...
              <br>
            <span class="info-box-text" id="demo13"></span>
            </div>
          </div>
        </div>
        </a>
        ...
        <div class="col-md-3 col-sm-6 col-xs-6">
          <div >      
            <div class="info-box-content">
            <span class="info-box-text" id="demo24"></span>
            <span class="info-box-icon bg-green"> <img src="https://as1.ftcdn.net/v2/jpg/04/87/13/40/1000_F_487134056_ttJAg56QAcB15RKhdOQUKPXGxwGt5xqB.jpg" width="130" height="30"><?php
              ...
              <br>
            <span class="info-box-text" id="demo14"></span>
            </div>
          </div>
        </div>
        </a>
