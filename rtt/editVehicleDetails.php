							...
							<div class="panel-heading" style="color: #070432; font-size: 16px ">SPEED LIMIT DEVICE</div>
								<div class="panel-body">
									<div class="form-group row">
		                                ...
		                                <div class="col-sm-4">
		                                	<div class="input-group date" data-provide="datepicker" >
				                                <input type="text" class="form-control"  name="sld_issue_date"    placeholder="Issue Date" value = "<?php echo  $vdata['sld_issue_date'] ?>" >
				                                <div class="input-group-addon">
				                                    <span class="glyphicon glyphicon-th"></span>
				                                </div>
				                            </div>
		                            ...
		                            <div class="form-group row">
		                                ...
		                                <div class="col-sm-4">
		                                	<div class="input-group date" data-provide="datepicker" >
				                                <input type="text" class="form-control"  name="sld_expiry_date" placeholder="Expiry Date" value = "<?php echo  $vdata['sld_expiry_date'] ?>" >
				                                <div class="input-group-addon">
				                                    <span class="glyphicon glyphicon-th"></span>
				                                </div>
				                            </div>
