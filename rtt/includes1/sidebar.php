<aside class="main-sidebar" style="background-color: rgba(14,26,53,1) !important;" >
        ...
        <div class="pull-left info">
          ...
          <a href="#"><i class="fa fa-circle text-success"></i> Online</a>
              ...
              <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                  <a href="https://vahanfin.com/application/rtt/dashboard.php">
                  ...
                  <ul class="treeview-menu">
                    <li ><a href="https://vahanfin.com/application/rtt/dashboard.php"><i class="fa fa-circle-o"></i> Dashboard</a></li>
                
        
                    <li><a href="https://vahanfin.com/application/rtt/myProfile.php"><i class="fa fa-circle-o"></i> My Profile</a></li>
   ...
   <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <li ><a href="https://vahanfin.com/application/rtt/getVehicleDetails.php"><i class="fa fa-circle-o"></i> Fleet Details</a></li>
                ...
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <li ><a href="https://vahanfin.com/application/rtt/rto/totalVehicle.php"><i class="fa fa-circle-o"></i>Status</a></li>
