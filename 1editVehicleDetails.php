<?php 
    ...
    if($_POST)
    {
    	if(isset($_POST['upd']))
		{
			...
			if(isset($_FILES['gov_document']))
			{
				$g_doc = '';
				$errors= array();
				$file_name = $_FILES['gov_document']['name'];
				$file_size =$_FILES['gov_document']['size'];
				$file_tmp =$_FILES['gov_document']['tmp_name'];
				$file_type=$_FILES['gov_document']['type'];
				$tmp = explode('.', $file_name);
				$file_ext = end($tmp);
				$expensions= array('jpg', 'jpeg', 'png', 'pdf', 'doc', 'docx', 'ppt', 'pptx', 'xls', 'xlsx');
				...
				if(empty($errors)==true)
				{
					if($vdata)
					{
						if(!empty($vdata['gov_document']))
						{
							$oldImg = 'uploads/vehicle_documents/government/'.$vdata['gov_document'];
							unlink($oldImg);
						}
					}
					$path = "uploads/vehicle_documents/government/";
					$path = $path . time().".". $file_ext;
					if(move_uploaded_file($_FILES['gov_document']['tmp_name'], $path))
					{
						$g_doc = time().".". $file_ext;
					}
					else
			...
			if(!empty($g_docs))
		    {
		    	$data['gov_document'] =$g_docs;
		    }
			$data['gov_issue_date'] =date('Y-m-d',strtotime($_POST['gov_issue_date']));
		    $data['gov_expiry_date'] =date('Y-m-d',strtotime($_POST['gov_expiry_date']));
			...
			<div class="box-body " style="padding:30px;">
				...
				<form  class="form-horizontal" action="#" id="regForm" method="POST" enctype="multipart/form-data"><br/><br/>
							...
							<div class="panel-heading" style="color: #070432; font-size: 16px ">FITNESS</div>
								<div class="panel-body">
									<div class="form-group row">
		                                ...
		                                <div class="col-sm-4">
		                                	<div class="input-group date" data-provide="datepicker" >
				                                <input type="text" class="form-control"  name="fitness_issue_date"  placeholder="Issue Date" value = "<?php echo  $vdata['fitness_issue_date'] ?>">
		                            ...
		                            <div class="form-group row">
		                                ...
		                                <div class="col-sm-4">
		                                	<div class="input-group date" data-provide="datepicker" >
				                                <input type="text" class="form-control"  name="fitness_expiry_date" placeholder="Expiry Date" value = "<?php echo  $vdata['fitness_expiry_date'] ?>">
				                                <div class="input-group-addon">
				                                    <span class="glyphicon glyphicon-th"></span>
				                                </div>
				                            </div>
					...
					<div class="form-group row">
                        <div class="col-sm-12">
                            <div class="panel panel-default">
							<div class="panel-heading" style="color: #070432; font-size: 16px ">gov doc</div>
								<div class="panel-body">
									<div class="form-group row">
		                                <label for="email" class="col-sm-2 form-label" style="font-size: 12px">
		                                    ISSUE DATE</label>
		                                <div class="col-sm-4">
		                                	<div class="input-group date" data-provide="datepicker" >
				                                <input type="text" class="form-control"  name="gov_issue_date"   placeholder="Issue Date" value = "<?php echo  $vdata['gov_issue_date'] ?>" >
				                                <div class="input-group-addon">
				                                    <span class="glyphicon glyphicon-th"></span>
				                                </div>
				                            </div>
		                            ...
		                            <div class="form-group row">
		                                ...
		                                <div class="col-sm-4">
		                                	<div class="input-group date" data-provide="datepicker" >
				                                <input type="text" class="form-control"  name="gov_expiry_date"   placeholder="Expiry Date" value = "<?php echo  $vdata['gov_expiry_date'] ?>" >
				                                <div class="input-group-addon">
				                                    <span class="glyphicon glyphicon-th"></span>
				                                </div>
				                            </div>
		                                ...
		                                <label for="mobile" class="col-sm-2 form-label" style="font-size: 12px">
				                            DOCUMENT</label>
											<div class="col-sm-2">
				                            <input type="file" class="form-control" name="gov_document"/>
				                        </div>
				                        <div class="col-sm-2">    <?php 
				                            if($vdata['gov_document'])
				                            {
				                            	?>
				                            		<a href = 'uploads/vehicle_documents/government/<?php echo $vdata['gov_document'];?>' class="btn btn-primary" target="_blank" >View Document</a>
				                            	<?php
				                            }
				                            ?>
				                        </div>
