<aside class="main-sidebar" style="background-color: rgba(14,26,53,1) !important;" >
   ...
   <li class="treeview">
                  <a href="#">
                    <i class="fa fa-crosshairs"></i> <span>PDD</span>
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                  <ul class="treeview-menu">
                    <li ><a href="dashboard.php"><i class="fa fa-circle-o"></i> Add vehicle</a></li>
                  ...
                  <ul class="treeview-menu">
                    <li ><a href="rtt/rto/dashboard.php"><i class="fa fa-circle-o"></i>View Status</a></li>
