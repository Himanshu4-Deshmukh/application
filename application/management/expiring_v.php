            ...
            <div class="col-lg-12 col-md-12">
              <div class="card">
                <div class="card-header card-header-warning">
                  <h4 class="card-title" style="display: inline">Expiring Vehicles</h4>
                ...
                <div class="card-body table-responsive">
                      ...
                      else
                      {
                        ...
                        $nowdate = date("Y-m-d", strtotime("+0 days"));
                          ...
                          $sql="SELECT * FROM vehicle WHERE (fitness_expiry_date<'$expdate' AND fitness_expiry_date>'$nowdate'
                                ...
                                OR rt_expiry_date<'$expdate' AND rt_expiry_date>'$nowdate'
                                OR tt_expiry_date<'$expdate' AND tt_expiry_date>'$nowdate'
                                OR pollution_expiry_date<'$expdate' AND pollution_expiry_date>'$nowdate') AND customer_id = '$cust' LIMIT " . $cur_page . ',' .  $rpp;
                          $result=mysqli_query($conn,$sql);
                 ...
                 <?php
                  ...
                  {
                    $prev="expiring_v.php?page=".($page-1);
                  }
                  ...
                  {
                    $nxt="expiring_v.php?page=".($page+1);
                  }
                

                      echo '<div id="pagination_div" style="margin: 0px auto; text-align: center;">
                      <a href="expiring_v.php?page=1" style="margin-right: 10%"><i class="fa fa-fast-backward" style="color:grey"></i></a>
                  ...
                  <a href="expiring_v.php?page='.$num_pages.'" style="margin-left: 10%"><i class="fa fa-fast-forward" style="color:grey"></i></a>
                  </div>';
                      ?>
                </div>
              </div>
