          ...
          ?> 
            ...
            <?php 
              ...
              $sql = "SELECT * FROM vehicle WHERE (fitness_expiry_date<'$expdate' AND fitness_expiry_date>'$nowdate'
                      ...
                      OR rt_expiry_date<'$expdate' AND rt_expiry_date>'$nowdate'
                      OR tt_expiry_date<'$expdate' AND tt_expiry_date>'$nowdate'
                      OR pollution_expiry_date<'$expdate' AND pollution_expiry_date>'$nowdate') AND customer_id = '$cust'";
              $result = mysqli_query($conn,$sql);             
            ...
            <div class="col-lg-12 col-md-12">
              <div class="card">
                <div class="card-header card-header-warning">
                  <h4 class="card-title" style="display: inline">Active Vehicles</h4>
                  <form action="" method="post" style="display: inline; float:right">
                    
                        <input type="text" class="form-control" placeholder=" Search" name="search" style="width: 79%; background-color: white; display: inline">
                        <div class="input-group-append" style="display: inline">
                        <button class="btn btn-outline-primary" type="submit" id="search_btn1" style="padding:9px"><i class="fa fa-search"></i></button>
                        </div>
                    </form>
                </div>
                <div class="card-body table-responsive">
                  ...
                  while($row=mysqli_fetch_assoc($result))
                      ...
                      foreach($data as $val)
                      {
                        ...
                        <tr>
                            ...
                            <td><?php $customer = $val["customer_id"];
                      ...
                      // jass new change
                        ...
                        // jass new change
                            ...
                            $sql = "SELECT * FROM vehicle WHERE 
                                    ...
                                    OR rt_expiry_date<'$nowdate' AND rt_expiry_date!='1970-01-01' AND rt_expiry_date!=''
                                    OR tt_expiry_date<'$nowdate' AND tt_expiry_date!='1970-01-01' AND tt_expiry_date!=''
                                    OR pollution_expiry_date<'$nowdate' AND pollution_expiry_date!='1970-01-01' AND pollution_expiry_date!='') AND customer_id = '$cust' LIMIT " . $cur_page . ',' .  $rpp;
                 ...
                 <?php
                  ...
                  {
                    $nxt="active_v.php?page=".($page+1);
                  }
                

                      echo '<div id="pagination_div" style="margin: 0px auto; text-align: center;">
                      <a href="active_v.php?page=1" style="margin-right: 10%"><i class="fa fa-fast-backward" style="color:grey"></i></a>
                  ...
                  <a href="active_v.php?page='.$num_pages.'" style="margin-left: 10%"><i class="fa fa-fast-forward" style="color:grey"></i></a>
                  </div>';
                      ?>
                </div>
              </div>
