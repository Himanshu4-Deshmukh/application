           ...
           <li class=nav-item>
            ...
            <form action="loginvalidate.php" method="post" class="log1" style="height:450px">
              ...
              <!-- //login form -->
                    ...
                    <li class=nav-item>
            <a id="anchor1" href="#" onClick="signupForm()"><i class="fa fa-user-plus"></i> Sign Up</a>
            <!-- Sign up form -->
            <div id="signup_form" class="loginform">
                <p id="log2" style=" font-weight:300; font-family: Roboto Condensed;">
                    <i class="fa fa-user-plus" style="margin-right: 2%; color:#cb3333"></i> Sign Up
                    <a href="#" onClick="signupForm()" style="float: right; color: #cb3333;">
                            <i class="fa fa-times" style="color:#cb3333;"></i>
                    </a>
                </p>
                
            <form action="" method="post" class="log1" style="height:650px">
            
                <div class="form-group">
                <center> <p style=" color: #fff;  font-weight:300; font-family: Roboto Condensed;">Or connect with</p></center>
                <div class="col-sm-12">
                    <div style="width:100%; padding:5px; margin:5px; text-align:center; background-color:white; border-radius:5px">';
                          $gloginURL = "";
                          $authUrl = $googleClient->createAuthUrl();
                          $gloginURL = filter_var($authUrl, FILTER_SANITIZE_URL);
                      echo '<a  class="login100-social-item" href="'.htmlspecialchars($gloginURL).'"><img src="https://commons.wikimedia.org/wiki/File:Google_%22G%22_Logo.svg">Sign up Google</a>
                      </div>
                  </div>
                  ...
                  <label for="name" id="log3">User name</label>
                  <input type="text" class="form-control" id="name" name="uname">
                </div>
                <div class="form-group">
                  <label for="mno" id="log3">Mobile no</label>
                  <input type="number" class="form-control" id="mno" name="mob">
                </div>
                <div class="form-group">
                  <label for="email" id="log3">Email</label>
                ...
                <div class="form-group"><br>
                 <center><button type="submit" name="Submit" class="btn btn-danger btn-lg" style="height: 56px; font-weight:300; font-family: Roboto Condensed;"><i class="fa fa-lock" style="color:#cb3333;"></i> Register</button></center>
              </div>              </form>
              </div>
              <!-- //signup form -->
                </li>
                    ...
                    <!--<div class="livedemo-btn-container" id="myBtn" style="background-color: rgba(14,26,53,1) !important;"><p id="form-data" style="color: white ! important; display: inline">';
                    echo (!empty($_COOKIE['cityname'])?$_COOKIE['cityname']:"Select City");
                    echo'</p> <i class="fa fa-chevron-down" style="color:#cb3333;"></i></div> -->
                      <ul class="nav navbar-nav">
                       <li class=nav-item>
