 ...
 ?>  
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1 style="font-size:20px !important">REAL-TIME STATUS RTA APPLIED FILES STATUS</h1>
      <ol class="breadcrumb">
        <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Real-time status RTA applied files Status</li>
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title" style="display: inline !important" >
                <span style="float: left; font-size:15px">PROCESS DOCUMENTS</span><br>
...
<!--                           <th class="mob">Owner Name</th> -->
                  ...
                  <tbody>
                   ...
                   if(isset($_POST["search"]))
                   {
                    ...
                    $rpp=2;
                    $sql="SELECT * FROM `track` LEFT JOIN `vehicle` ON track.vehicle_id = vehicle.id  WHERE vehicle.user_id='$id'";
                  ...
                  $cur_page = ($page-1)*$rpp;
                  $c=($page*2)-1;
                  $sql="SELECT * FROM `track` LEFT JOIN `vehicle` ON track.vehicle_id = vehicle.id  WHERE vehicle.user_id = '$id' LIMIT " . $cur_page . ',' . $rpp;
                  $result=mysqli_query($conn,$sql);
                  while($row=mysqli_fetch_assoc($result))
                  {
                    echo '<tr>
            ...
            <div class="box-footer clearfix">
              ...
              {
                $prev="totalRecDocument.php?page=".($page-1);
              }
              if($page==$num_pages)
              {
                $nxt="#";
              ...
              {
                $nxt="totalRecDocument.php?page=".($page+1);
              }
                  echo '<div id="pagination_div" style="margin: 0px auto; text-align: center;">
                  <a href="totalRecDocument.php?page=1" style="margin-right: 10%"><i class="fa fa-fast-backward" style="color:grey"></i></a>
              ...
              <a href="totalRecDocument.php?page='.$num_pages.'" style="margin-left: 10%"><i class="fa fa-fast-forward" style="color:grey"></i></a>
              </div>';
                  ?>
            </div>
          </div>
