<aside class="main-sidebar" >
          ...
          <a href="#"><i class="fa fa-circle text-success"></i> Online</a>
                ...
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <li ><a href="https://vahanfin.com/application/dashboard.php"><i class="fa fa-circle-o"></i> Dashboard</a></li>
   ...
   <li class="treeview">
                  <a href="#">
                    <i class="fa fa-crosshairs"></i> <span>Services</span>
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                  <ul class="treeview-menu">
                    <li ><a href="https://vahanfin.com/application/dashboard.php"><i class="fa fa-circle-o"></i> Documents Upload</a></li>
                 ...
                 <li class="treeview">
                  <a href="#">
                    <i class="fa fa-crosshairs"></i> <span>Pricing</span>
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                  <ul class="treeview-menu">
                    <li ><a href="https://vahanfin.com/application/1getVehicleDetails.php"><i class="fa fa-circle-o"></i>RTO wise pricing</a></li>
                    
                  </ul>
                </li>
                <li class="treeview">
                  <a href="#">
                    <i class="fa fa-crosshairs"></i> <span>status</span>
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                  <ul class="treeview-menu">
                    <li ><a href="https://vahanfin.com/application/service/dashboard.php"><i class="fa fa-circle-o"></i>View Status</a></li>
