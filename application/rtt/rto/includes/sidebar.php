              ...
              <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li ><a href="getVehicleDetails.php"><i class="fa fa-circle-o"></i>Fleet Dashboard</a></li>
                    <li ><a href="rto/totalVehicle.php"><i class="fa fa-circle-o"></i> Status Dashboard</a></li>
