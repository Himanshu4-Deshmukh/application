<?php 
	...
	$vdata = getExpirdVehicleData($customer,$sec);
	// print_r($vdata);die();
	$udata = getAllUser();
      ...
      <!-- Small boxes (Stat box) -->
        ...
        <div class="box box-success"  id="userForm" style="display:none;">
      	...
      	<div class="box box-success" >
				<div class="box-header with-border">
					<?php $totalVehicle = getExpiredCountVehicle($customer,$sec); 
					?>
					        	...
					        	<?php 
					        		if($vdata)
					        		{
					        			...
					        			foreach ($vdata as $val) 
					        			{
					        				...
					        				?>
						        			<tr>
								                <td style="text-align: center; font-size:12px"><?php echo $c ?></td>
								                <td style="text-align: center; font-size:12px"><?php echo $val['firstname']." ".$val['lastname']; ?></td>
								                <td style="text-align: center; font-size:12px"><?php echo $val['reg_no'] ?></td>
								                <td style="text-align: center; font-size:12px"><?php echo $val['model'] ?></td>
								                
								                <td style="text-align: center; font-size:12px"><?php echo $val['mfg_by'] ?></td>
								                <td style="text-align: center; font-size:12px"><?php echo date('d-m-Y',strtotime($val['mfg_date'])); ?></td>
								                <td style="text-align: center; font-size:12px"><?php echo date('d-m-Y',strtotime($val['reg_date'])); ?></td>
