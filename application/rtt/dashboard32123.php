			...
			<div class="box-body " style="padding:30px;">
				...
				<form  class="form-horizontal" action="#" id="regForm" method="POST" enctype="multipart/form-data"><br/>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="reg_no" class="form-control" id="reg_no" placeholder="MH02AF6571." required="required"  />
                        </div>

                        <label for="email" class="col-sm-2 form-label" style="font-size: 12px">
                            Proposed by</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="model" id="model" placeholder="Your Name" required="required" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="mobile" class="col-sm-2 form-label" style="font-size: 12px;">
                            Location</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="mfg_by" id="mfg_by" placeholder=" Location" required="required" />
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <div class="panel panel-default">
							<div class="panel-heading" style="color: #070432; font-size: 16px ">Loasn Statement,Notice and Invoice</div>
								<div class="panel-body">
									<div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <div class="panel panel-default">
							<div class="panel-heading" style="color: #070432; font-size: 16px ">KYC Registeered owner and SFL</div>
								<div class="panel-body">
									<div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <div class="panel panel-default">
							<div class="panel-heading" style="color: #070432; font-size: 16px ">Authorised Person (Adhaar,Photo</div>
								<div class="panel-body">
									<div class="form-group row">
						...
						<table id="vehicle_tbl" class="table-bordered table-hover table table-striped" style="width:100%">
					        <thead>
								...
								<th style="text-align: center; font-size:12px" class="dm">Pollution</th>
									...
									<th style="text-align: center; font-size:12px" class="dm">Permit</th><th style="text-align: center; font-size:12px" class="dm">Permit</th><th style="text-align: center; font-size:12px" class="dm">Permit</th>
					        ...
					        <?php
                                ...
                                <td class="dm" style="text-align: center;"><?php echo date('d-m-Y',strtotime($val['tt_expiry_date'])); ?></td>
						                		...
						                		<td class="dm" style="text-align: center;">
								                	<a href= "frceditVehicleDetails.php?id=<?php echo $val['id'] ?>">
