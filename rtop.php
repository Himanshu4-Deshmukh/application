...
<body>
 ...
 <div class="col-md-12 form-group text-center">
          <img src="http://vahanfin.com/logomain.png" alt="Vahanfin" width="128">
RTO PRICING      
 <div class="section-gap">&nbsp;</div> <div class="section-gap">&nbsp;</div>  
      </div>
    ...
    <form name="aufnahme" id="aufnahme" action="<?= $thisfile ?>" method="post" enctype="multipart/form-data"class="row">
      ...
      <ol class="breadcrumb">
        <li><i class="fa fa-car"></i> Select vehicle catagory</li>
          </ol>
      ...
      <div class="col-md-4 col-sm-12 form-group">
         <ol class="breadcrumb">
        <li><i class="fa fa-home"></i> RTO</li>
    ...
    <?php if ($numRows > 0) {
      ...
      <div class="data-container">
         <ol class="breadcrumb">
        <li><i class="fa fa-home"></i> RTO : <span class="data-value"><?php echo $row['rto']; ?></span></li>
