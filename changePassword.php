      	...
      	<div class="col-sm-8">
			...
			<div class="box box-success">
				<div class="box-header with-border">
					<h3 class="box-title"><p style="font-size: 14px">CHANGE PASSWORD</p></h3>
				...
				<div class="box-body">
					...
					<form method="post" id="adminChangePassword">
						...
						<div class="form-group row">
						    <label for="inputEmail3" class="col-sm-4 col-form-label" style="font-size: 12PX">OLD PASSWORD</label>
						    <div class="col-sm-8">
						      <input type="password" class="form-control name="oldpass" id="oldpass" required/>
						    </div>
						</div>
						<div class="form-group row">
						    <label for="inputEmail3" class="col-sm-4 col-form-label" style="font-size: 12PX">NEW PASSWORD</label>
						    <div class="col-sm-8">
						      <input type="password" class="form-control name="newpass" id="newpass" required>
						    </div>
						</div>
						<div class="form-group row">
						    <label for="inputPassword3" class="col-sm-4 col-form-label" style="font-size: 12PX">CONFIRM NEW PASSWORD</label>
						    <div class="col-sm-8">
