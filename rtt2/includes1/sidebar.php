              ...
              <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <!--<li ><a href="trackdashboard.php"><i class="fa fa-circle-o"></i> Track Dashboard</a></li>-->
                ...
                <li id="status" class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <li ><a href="service/dashboard.php"><i class="fa fa-circle-o"></i> Status</a></li>
