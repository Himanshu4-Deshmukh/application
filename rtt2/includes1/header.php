...
include('includes1/function.php');
include('conn.php');
?>
<!DOCTYPE html>
<html>
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="bower_components1/bootstrap/dist/css/bootstrap.min.css">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="bower_components1/font-awesome/css/font-awesome.min.css">
  <!-- Ionicons -->
  ...
  <!-- Date Picker -->
  <link rel="stylesheet" href="bower_components1/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="bower_components1/bootstrap-daterangepicker/daterangepicker.css">
  <!-- bootstrap wysihtml5 - text editor -->
  <link rel="stylesheet" href="plugins1/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
  <!-- Datatables -->
  <link rel="stylesheet" href="bower_components1/datatables.net/jquery.dataTables.min.css">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="#">0 Messages</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="#">0 Notification</a></li>
            </ul>
          </li>
          ...
          <?php 
            ...
            if($user_data['profile_pic'])
            {
                ...
                {
                  $img = "uploads1/profile_pic/".$user_data['profile_pic'];

                }
            }
            else
            {
                $img =  "assets1/images/no_image.png";
            }
          ?>
