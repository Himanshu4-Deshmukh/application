<?php 
	...
	$sec = $_GET['sec'];
	$id = $_SESSION['uid'];
	$vdata = getExpirdVehicleData($id,$sec);
	// print_r($vdata);die();
	$udata = getAllUser();
      ...
      <!-- Small boxes (Stat box) -->
        ...
        <div class="box box-success"  id="userForm" style="display:none;">
      	...
      	<div class="box box-success" >
				<div class="box-header with-border">
					<?php $totalVehicle = getExpiredCountVehicle($id,$sec); 
					?>
					        		...
					        		if($vdata)
					        		{
					        			...
					        			foreach ($vdata as $val) 
					        			{
						        			...
						        			<tr>
								                ...
								                <td><a href= "viewVehicleDetails.php?id=<?php echo $val['id'] ?>" class="btn btn-primary" >View</a> &nbsp;</td>   
								            </tr>
							            	<?php
							            	$c++;
							        	}
