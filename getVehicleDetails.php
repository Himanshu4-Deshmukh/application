...
if ($_POST) {
	if (isset($_POST['add'])) {
		...
		// img, docs are uploading in folder but unable to display
	...
	<section class="content">
		...
		<div class="box box-success">
			<div class="box-header with-border">
				...
				<h3 class="box-title">
					<p style="font-size: 12px; margin-top:18px">TOTAL VEHICLE &nbsp; &nbsp;<u style="font-size: 12px;"><?php echo $totalVehicle ?></u></p>
				</h3>
